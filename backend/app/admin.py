...
class FlexibleBulkImportView(BaseView):
    ...
    def __init__(self):
        ...
        self.identity = "flexible-bulk-import"
                ...
                for i, raw_item in enumerate(raw_data):
                    try:
                        ...
                        if content_field not in raw_item:
                            raise ValueError(f"Required field '{content_field}' not found")
                        ...
                        for key in content_field.split('.'):
                            if isinstance(content_value, dict) and key in content_value:
                                ...
                                raise ValueError(f"Field path '{content_field}' not found")
...
class BulkTaskImportView(BaseView):
    ...
    def __init__(self):
        ...
        self.identity = "bulk-task-import"
