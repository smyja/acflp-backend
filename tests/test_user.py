...
class TestWriteUser:
    ...
    async def test_create_user_success(self, mock_db, sample_user_data, sample_user_read):
        ...
        with patch("app.api.v1.users.crud_users") as mock_crud:
            ...
            with patch("app.api.v1.users.get_password_hash") as mock_hash:
...
class TestReadUsers:
    ...
    async def test_read_users_success(self, mock_db):
        ...
        with patch("app.api.v1.users.crud_users") as mock_crud:
            ...
            with patch("app.api.v1.users.paginated_response") as mock_paginated:
...
class TestEraseUser:
    ...
    async def test_erase_user_success(self, mock_db, current_user_dict, sample_user_read):
        ...
        with patch("app.api.v1.users.crud_users") as mock_crud:
            ...
            with patch("app.api.v1.users.blacklist_token", new_callable=AsyncMock) as mock_blacklist:
