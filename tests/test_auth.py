...
from app.api.v1.login import login, refresh_access_token
from app.api.v1.logout import logout
...
class TestLogin:
    ...
    async def test_login_success(self, mock_db):
        ...
        with patch("app.api.v1.login.authenticate_user") as mock_auth:
            mock_auth.return_value = mock_user
            
            with patch("app.api.v1.login.create_access_token") as mock_access_token:
                mock_access_token.return_value = "mock_access_token"
                
                with patch("app.api.v1.login.create_refresh_token") as mock_refresh_token:
...
class TestRefreshToken:
    ...
    async def test_refresh_token_success(self, mock_db):
        ...
        with patch("app.api.v1.login.verify_token") as mock_verify:
...
class TestLogout:
    ...
    async def test_logout_success(self, mock_db):
        ...
        with patch("app.api.v1.logout.blacklist_tokens") as mock_blacklist:
